            ...
            <tr>
              ...
              <?php if(!empty($department)):?>
                  <?php foreach($department as $keys=>$value):?>
                      <?php if($user[$key]['department_id'] == $department[$keys]['id']):?>
                      <td><?=$department[$keys]['department_code']?></td>
                      <?php endif;?>
                  <?php endforeach;?>
              <?php endif;?>
              <?php if($user[$key]['course_id']==null):?>
                <td> </td>
              <?php endif;?>
              <?php if(!empty($course)):?>
                  <?php foreach($course as $keys=>$value):?>
                      <?php if($user[$key]['course_id'] == $course[$keys]['id']):?>
                      <td><?=$course[$keys]['course_description']?></td>
                      <?php endif;?>
                  <?php endforeach;?>
              <?php endif;?>
              <?php if(!empty($role)):?>
                  <?php foreach($role as $keys=>$value):?>
                      <?php if($user[$key]['role_id'] == $role[$keys]['id']):?>
                        <td><?=$role[$keys]['role']?></td>
                      <?php endif;?>
                  <?php endforeach;?>
              <?php endif;?>
              <td><?=$user[$key]['date_validate']?></td>
              <td><a href="<?=ROOT?>/manage?id=<?=$user[$key]['school_id']?>">View</a></td>
            </tr>
            <?php endif;?>
          <?php endforeach;?>
        </tbody>
