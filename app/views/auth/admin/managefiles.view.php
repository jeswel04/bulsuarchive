...
<div class="container">
  ...
  <table>
        <thead>
          <tr>
            <th>Title</th>
            <th>Researcher Represantative</th>
            <th>Type</th>
            <th>Department</th>
            <th>Course</th>
            <th>Adviser</th>
        ...
        <tbody>
          <?php if(!empty($research)):?>
              <?php foreach($research as $keys=>$value):?>
                <tr>
                    <td><?=$research[$keys]['title']?></td>
                    <td><?=$research[$keys]['researchers']?></td>
                    <td><?=$research[$keys]['type']?></td>
                    ...
                    <?php if(!empty($course)):?>
                        ...
                        <?php endforeach;?>
                    <?php endif;?>
                    <td><?=$research[$keys]['adviser']?></td>
                    <td><?=$research[$keys]['date_research']?></td>
                    <td><a href="<?=ROOT?>/editfile?id=<?=$research[$keys]['research_token']?>">View</a></td>
                </tr>
              <?php endforeach;?>
          <?php endif;?>
        </tbody>
